...
// CaptionPreference stores whether subtitles were last enabled in a server.
...
// CaptionsEnabled reports whether subtitles were last turned on in the guild.
...
// SetCaptionsEnabled persists the guild's latest subtitle preference.
