...
// FebboxScanner looks for sidecar subtitle files in a Febbox share folder.
...
// SidecarMatch is a subtitle file discovered beside a Febbox video.
...
// Download writes a discovered sidecar subtitle to destPath.
